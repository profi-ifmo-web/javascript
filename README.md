...
2. Задача "Школа":
        ...
        создается со следующими характеристиками:
            ...
            уровень знаний 
        и методом:
            учиться() - уровень знаний ученика повышается на рандомное значение
        ...
        плюс методом:
            день в школе() -  учителя учат учеников (предмет учителя и ученика должны совпадать)
